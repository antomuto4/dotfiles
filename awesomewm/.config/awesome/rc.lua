...
globalkeys = gears.table.join(
    ...
    awful.util.spawn("rofi -show") end,
              {description = "rofi show windows", group = "awesome"}),
    ...
    awful.key({ modkey },            "d",     function ()
        awful.util.spawn(terminal.."discord") end,
      {description = "discord run", group = "launcher"}),

    -- Spotify
    
    awful.key({ modkey, "Shift"   },            "s",     function ()
        awful.util.spawn(terminal.."flatpak run com.spotify.Client") end,
      {description = "spotify run", group = "launcher"}),

      -- Firefox
      
	    awful.key({ modkey, "Shift"   },            "f",     function ()
        awful.util.spawn("firefox") end,
      {description = "firefox run", group = "launcher"}),
      
      -- Visual Studio Code
      
	    awful.key({ modkey, "Shift"   },            "v",     function ()
        awful.util.spawn("code-oss") end,
      {description = "visual studio code run", group = "launcher"}),

      -- Betterlockscreen
      	awful.key({modkey, "Shift"}, "s", function()
      	awful.util.spawn("betterlockscreen  --lock blur") end,
      	{description = "betterlockscreen run", group = "launcher"}),
